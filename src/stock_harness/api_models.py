...
class AiChatConversationInput(BaseModel):
    context_kind: Literal[
        "trend_analysis", "signal_run", "signal_workspace", "learning_system"
    ] = "trend_analysis"
...
class AiChatTurnInput(BaseModel):
    ...
    learning_asset_path: str | None = Field(default=None, min_length=1, max_length=500)
    learning_page_title: str | None = Field(default=None, max_length=200)
